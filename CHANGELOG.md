...
* **auth:** L0 固定 RSA 签名私钥持久化 + fail-fast（管理台强制认证前置） ([#1089](https://github.com/tomturing/hci-troubleshoot-platform/issues/1089)) ([39ec77d](https://github.com/tomturing/hci-troubleshoot-platform/commit/39ec77dd0fbf0d0ae903f414d06d04b311719199))
* **auth:** PR-D 落地 apiGateway.authnEnforceAdmin 强认证开关（默认 false） ([#1097](https://github.com/tomturing/hci-troubleshoot-platform/issues/1097)) ([bd03631](https://github.com/tomturing/hci-troubleshoot-platform/commit/bd0363112ca9832cb5c918b8d5d3af3353cb254c))
* **auth:** 共享令牌→admin 回退加审计埋点（关后门实测判据） ([#1100](https://github.com/tomturing/hci-troubleshoot-platform/issues/1100)) ([29d6f0e](https://github.com/tomturing/hci-troubleshoot-platform/commit/29d6f0e93d8e0d6ab08363713a0a61ce0bb85452))
* **auth:** 统一认证阶段0 — schema 基础 + auth-service 骨架 ([#1077](https://github.com/tomturing/hci-troubleshoot-platform/issues/1077)) ([1942a20](https://github.com/tomturing/hci-troubleshoot-platform/commit/1942a20c76056f0c9fb862fbfa9132d25e06f031))
* **auth:** 阶段1 网关 JWT 验签 + admin 灰度 flag（PR [#1078](https://github.com/tomturing/hci-troubleshoot-platform/issues/1078)） ([#1079](https://github.com/tomturing/hci-troubleshoot-platform/issues/1079)) ([4ff6eff](https://github.com/tomturing/hci-troubleshoot-platform/commit/4ff6eff4f146d45f4e947383ef8fa81fb60f54bb))
* **auth:** 阶段1.x 默认管理员登录打通（admin/aihci@aclient2025） ([#1080](https://github.com/tomturing/hci-troubleshoot-platform/issues/1080)) ([0db5a83](https://github.com/tomturing/hci-troubleshoot-platform/commit/0db5a83befab7be28d33b639d77ee80ab13a6b43))
...
* **custom-ui:** SSH 连接后 acli 自动检测与静默安装更新 ([#1058](https://github.com/tomturing/hci-troubleshoot-platform/issues/1058)) ([be0789b](https://github.com/tomturing/hci-troubleshoot-platform/commit/be0789b892e17db0d38305bca8ffb249a64f9511))
* KBD 审核责任人与无法发布状态功能 ([#1090](https://github.com/tomturing/hci-troubleshoot-platform/issues/1090)) ([77d5247](https://github.com/tomturing/hci-troubleshoot-platform/commit/77d5247d7028175aa4769b2a60bb731513ea4b7f))
...
* **kbd:** 重新启用 qfk_var 通用变量采集原语（专家维护 free shell） ([#1067](https://github.com/tomturing/hci-troubleshoot-platform/issues/1067)) ([bb15921](https://github.com/tomturing/hci-troubleshoot-platform/commit/bb15921654cf09bee70a8cb4b79cefbfbf6e8026))
...
* reference_only KBD 推荐兜底与 Alpine 镜像源配置 ([#1078](https://github.com/tomturing/hci-troubleshoot-platform/issues/1078)) ([eb420ad](https://github.com/tomturing/hci-troubleshoot-platform/commit/eb420adafc7a3a5e4695a3aa33f71899f1f43794))
* **security:** admin 前端强制登录并清除共享内部令牌回退（阶段1.z） ([#1091](https://github.com/tomturing/hci-troubleshoot-platform/issues/1091)) ([88d2851](https://github.com/tomturing/hci-troubleshoot-platform/commit/88d285190072eadd46b4a6ab3809a3160da0ab67))
...
* terminal_bridge 日志治理与本地日志上传补采（工单 Q2026092010235） ([#1060](https://github.com/tomturing/hci-troubleshoot-platform/issues/1060)) ([c6f1a8f](https://github.com/tomturing/hci-troubleshoot-platform/commit/c6f1a8ff6cb02ad3e271470dc7853ae04ed0fff8))
* 为无法发布状态添加审核备注提示（列表和详情页） ([#1095](https://github.com/tomturing/hci-troubleshoot-platform/issues/1095)) ([44b5f3f](https://github.com/tomturing/hci-troubleshoot-platform/commit/44b5f3f55e398a285f3e24610099901f59ab8c7f))
...
* **admin-ui:** KBD 信号下拉补 qfk_var 并优化采集类型下拉与 Console 审计文案 ([#1072](https://github.com/tomturing/hci-troubleshoot-platform/issues/1072)) ([40ae4fd](https://github.com/tomturing/hci-troubleshoot-platform/commit/40ae4fdd6b98a43d8df7caf786769ac18ca0e1a5))
* **admin-ui:** 统一信号下拉文案——变量/日志补「检查」后缀 ([#1075](https://github.com/tomturing/hci-troubleshoot-platform/issues/1075)) ([6753ff9](https://github.com/tomturing/hci-troubleshoot-platform/commit/6753ff962a46d23c4ba497972078c5dd259f3576))
...
* **auth:** 修复 auth-service 容器启动崩溃（依赖漂移 + 构建期闭包冒烟） ([#1081](https://github.com/tomturing/hci-troubleshoot-platform/issues/1081)) ([b5dc6fa](https://github.com/tomturing/hci-troubleshoot-platform/commit/b5dc6faffed4a8e239d40c84127a31c8601baa3a))
* **auth:** 修复登录 500（text() 的 :: 与绑定参数冲突） ([#1085](https://github.com/tomturing/hci-troubleshoot-platform/issues/1085)) ([94192cb](https://github.com/tomturing/hci-troubleshoot-platform/commit/94192cbaf44941b23803b6c8bbc1a19d7e3a366a))
* **auth:** 补齐 auth-service 的 opentelemetry instrumentation 依赖 ([#1083](https://github.com/tomturing/hci-troubleshoot-platform/issues/1083)) ([9347fa7](https://github.com/tomturing/hci-troubleshoot-platform/commit/9347fa78949ab36f12a81759a5670c8912cf1d36))
* **auth:** 认证路径改 /api/platform-auth/* 避开 Langfuse（修复登录 400） ([#1087](https://github.com/tomturing/hci-troubleshoot-platform/issues/1087)) ([7019700](https://github.com/tomturing/hci-troubleshoot-platform/commit/70197002eb24935da797cb086c4b0eb4f4434a49))
...
* **ci:** WS 集成测试适配服务端签名身份信任链，修复 main 持续 FAILURE ([#1068](https://github.com/tomturing/hci-troubleshoot-platform/issues/1068)) ([d64cf00](https://github.com/tomturing/hci-troubleshoot-platform/commit/d64cf000f4b718bb3886326159b30719cfe23af1))
...
* **ci:** 晋级脚本登记 authService 并加服务 key 契约防复发 ([#1082](https://github.com/tomturing/hci-troubleshoot-platform/issues/1082)) ([efc944e](https://github.com/tomturing/hci-troubleshoot-platform/commit/efc944e1b7007a4b539f09c94927198b670f983d))
...
* **deploy:** 根治 hci-sim 控制面令牌双 key 漂移（Runtime 与网关统一引用 INTERNAL_API_TOKEN） ([#1093](https://github.com/tomturing/hci-troubleshoot-platform/issues/1093)) ([ade0630](https://github.com/tomturing/hci-troubleshoot-platform/commit/ade0630b73f9a84a309ec24c0d401ad16910f8bb))
* **diagnosis:** 客户角色纳入客户侧权限集合，修复 B1 后离线诊断整体 403 ([#1073](https://github.com/tomturing/hci-troubleshoot-platform/issues/1073)) ([f4bf061](https://github.com/tomturing/hci-troubleshoot-platform/commit/f4bf061b3ac92cebd7c3a19fe65d1da5b58efe8d))
* **frontend:** 修正 QfkProcessingEditor 单测的类型错误导致 admin 构建失败 ([#1070](https://github.com/tomturing/hci-troubleshoot-platform/issues/1070)) ([a253a16](https://github.com/tomturing/hci-troubleshoot-platform/commit/a253a16163998a582987fc8f9c96ae7b3673ef81))
* **gateway:** admin JWT 身份补齐 client_id（下游必填身份路由不再 401） ([#1086](https://github.com/tomturing/hci-troubleshoot-platform/issues/1086)) ([884d5e6](https://github.com/tomturing/hci-troubleshoot-platform/commit/884d5e609fd3fcbc9ca5c8b1f4d351d7b1541529))
* **gateway:** 修复管理台 admin 接口 403（nginx 双 Bearer 回归 + 下游改用网关重签） ([#1088](https://github.com/tomturing/hci-troubleshoot-platform/issues/1088)) ([96cf9ed](https://github.com/tomturing/hci-troubleshoot-platform/commit/96cf9eda564bf122d213ddc0dc7a34731ad48c14))
...
* **ingress:** admin-ui 独立 internalGuard sourceRange（B3 域名收敛，SRC-2026-5358） ([#1076](https://github.com/tomturing/hci-troubleshoot-platform/issues/1076)) ([f3f3dd4](https://github.com/tomturing/hci-troubleshoot-platform/commit/f3f3dd4329604502c426ccb073d562d541ebd4f1))
...
* **security:** internal 管理面公网封禁——独立 guard Ingress + ipAllowList（SRC-2026-5358） ([#1066](https://github.com/tomturing/hci-troubleshoot-platform/issues/1066)) ([d7bb3aa](https://github.com/tomturing/hci-troubleshoot-platform/commit/d7bb3aa19b5ca16244848c17ea3a05072fce60fd))
* **security:** P0 修复 IDOR 越权——网关签发服务端身份 Cookie 并强制鉴权 ([#1064](https://github.com/tomturing/hci-troubleshoot-platform/issues/1064)) ([b4d54e6](https://github.com/tomturing/hci-troubleshoot-platform/commit/b4d54e645e9eafdb9240db1b60b6268bab2d25ca))
* **security:** P1 扩面加固——全路由鉴权封堵与 WS 身份信任链对齐 ([#1065](https://github.com/tomturing/hci-troubleshoot-platform/issues/1065)) ([e1e5bb4](https://github.com/tomturing/hci-troubleshoot-platform/commit/e1e5bb4ce7b662d70183fa64fa2bb73ef73c3d2c))
* **security:** 网关身份重签——删除 Customer UI 身份注入并收回 /api 到网关（SRC-2026-5358 B1） ([#1071](https://github.com/tomturing/hci-troubleshoot-platform/issues/1071)) ([611374c](https://github.com/tomturing/hci-troubleshoot-platform/commit/611374cf27d49d5c95018669909779a2204f05e2))
* SSE 空闲保活治理，修复长耗时诊断被代理空闲掐断 ([#1062](https://github.com/tomturing/hci-troubleshoot-platform/issues/1062)) ([4464617](https://github.com/tomturing/hci-troubleshoot-platform/commit/4464617b920be874b03987238404a09f0ea170a3))
...
* 修复审核责任人创建时空邮箱唯一约束冲突 ([#1096](https://github.com/tomturing/hci-troubleshoot-platform/issues/1096)) ([2e86d2e](https://github.com/tomturing/hci-troubleshoot-platform/commit/2e86d2e896ea1f2f18429a05152342c0d2296d10))
* 修复工单Q2026092053425排障交互卡片无响应与容器/宿主机执行异常 ([#1056](https://github.com/tomturing/hci-troubleshoot-platform/issues/1056)) ([a5c6e4d](https://github.com/tomturing/hci-troubleshoot-platform/commit/a5c6e4dc84ffd75771019791f47d6f17f22f0675))
...
* 明确 Skill 执行异常的 agent/LLM 问题边界，消除误导文案 ([#1063](https://github.com/tomturing/hci-troubleshoot-platform/issues/1063)) ([021e556](https://github.com/tomturing/hci-troubleshoot-platform/commit/021e556f5de54e07856c29cb365987ae1d95eb6f))
