...
VALUES
    (
        ...
        $$
        {
          ...
          "category_baseline": {"source": "kbd_category", "revision": "pending", "checksum": ""},
          "catalog_baseline": {"source": "qkv_alert", "revision": "pending", "checksum": ""},
          "template": {
            "data": [{
    ...
    (
        ...
        $$
        {
          ...
          "category_baseline": {"source": "kbd_category", "revision": "pending", "checksum": ""},
          "catalog_baseline": {"source": "qkv_task", "revision": "pending", "checksum": ""},
          "template": {
            "data": [{
    ...
    (
        ...
        $$
        {
          ...
          "category_baseline": {"source": "kbd_category", "revision": "pending", "checksum": ""},
          "catalog_baseline": {"source": "qfk_log", "revision": "pending", "checksum": ""},
          "template": {
            "lines": [
