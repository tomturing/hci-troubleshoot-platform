...
const draft = {
  ...
  kbd_checksum: 'sha256:kbd', signals_digest: 'sha256:signals', tool_contract_revision: 'tool-r25', policy_revision: 'policy-r1',
        compiler_revision: 'bundle-factory-v4-fixture-assets', draft_revision: 0, creator: 'compiler', created_at: '2026-08-18T00:00:00Z', updated_at: '2026-08-18T00:00:00Z', approvals: [], manifest,
}
