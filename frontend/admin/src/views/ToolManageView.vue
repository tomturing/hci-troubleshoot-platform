  ...
  <div class="tool-manage-container">
    ...
    <div class="page-header">
      <div class="header-row">
        <div>
          ...
          <p class="page-desc">管理 ReAct 引擎可调用的 HCI 诊断插件及 API 接口（共 {{ filteredTools.length }} 项）</p>
        </div>
    ...
    <el-card class="filter-card" shadow="never">
      ...
      <el-row :gutter="16" align="middle">
        ...
        <el-col :span="8" class="total-info">共 <strong>{{ filteredTools.length }}</strong> 个工具定义</el-col>
      </el-row>
    </el-card>
