...
| 2.2 | 2026-06-15 | **shared/models/__init__.py ORM 注册副作用消除**：使用 Python 3.7+ `__getattr__` 实现延迟导入，解决 kb-service 导入 `shared.models.dynamic_resource` 时触发 KB ORM 副作用导致 CrashLoopBackOff 的问题 |
