...
需求见[阶段 D 需求](../../../requirement/hci-sim/events/hci-sim阶段D-Scenario调度与通用KBD测试需求.md)。
...
- [阶段 D 任务](../../../task/hci-sim/events/hci-sim阶段D-Scenario调度与通用KBD测试任务.md)
- [阶段 D 验证](../../../verify/hci-sim/events/hci-sim阶段D-Scenario调度与通用KBD测试验证方案.md)
