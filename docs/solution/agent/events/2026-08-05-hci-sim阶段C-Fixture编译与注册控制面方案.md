...
本阶段建立离线控制面：把不可变 KBD revision、生产 Tool Contract、Policy 和经批准的真实 Artifact 编译成内容寻址、可审查、可失效的 Manifest v2 Bundle。需求见[阶段 C 需求](../../../requirement/events/2026-08-05-hci-sim阶段C-Fixture编译与注册控制面需求.md)。
