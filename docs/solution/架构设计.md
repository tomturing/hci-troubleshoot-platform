...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| **9.48** | **2026-08-07** | **CI 最小激活与快速门禁**：变更探测与 docs-governance 共用 checkout；后端测试解除 Helm/探针对齐无效等待并行执行；Signal Schema 校验并入 Lint；hci-sim runtime、Bridge、Manifest gate 按路径分流；PR 不再触发 Windows exe 构建。 | [CI 最小激活与快速门禁方案](events/2026-08-07-CI最小激活与快速门禁方案.md) |
