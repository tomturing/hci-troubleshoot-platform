...
| C | Resolver/Compiler、Registry/Storage、审批/stale/provenance | 被 B 阻断 | [阶段 C](agent/events/2026-08-05-hci-sim阶段C-Fixture编译与注册控制面方案.md) |
| D | Run/Attempt、Scheduler/Issuer、cache/overlay、Headless Runner/Oracle | 被 C 阻断 | [阶段 D](agent/events/2026-08-05-hci-sim阶段D-Scenario调度与通用KBD测试方案.md) |
| E | Calibration、Mutation、认证、容量、SLO/证据/运营 | 被 D 阻断 | [阶段 E](agent/events/2026-08-05-hci-sim阶段E产品级验证与规模化运营方案.md) |
