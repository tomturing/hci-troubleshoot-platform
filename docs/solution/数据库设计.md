...
*文档版本: 7.35 | 更新日期: 2026-08-04 | 27 张表清单已对齐 `desired_schema.sql`，含 KBD Proposal/Expert 显式基线、Prompt v2.1 存量收敛、Candidate 告警召回、Matcher/采集器 evidence、命令能力与 phase 语义约束说明*
