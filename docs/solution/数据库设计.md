...
| **6.3** | **2026-04-08** | **dbmate 机制三层全面修复**：删除重复 version `20260402001_sop_tables.sql`，新建 `20260408001_sop_tables_fix_version.sql` 补齐 `sop_document`/`sop_chunk` 建表；baseline 补充 407001-003 版本；CI 新增重复 version 检测。详见 [事件文档](events/2026-04-08-dbmate迁移机制全面修复方案.md) |
...
*文档版本: 6.3 | 更新日期: 2026-04-08 | 17 张表全量覆盖，含 ER 图 + 两个状态机图*
