...
> **迁移工具**: Atlas（自 v6.3 起，替换 dbmate）  
> **迁移目录**: `database/atlas-migrations/`  
> **期望 Schema**: `database/desired_schema.sql`（唯一权威定义，跨所有文档）  
...
*文档版本: 6.5 | 更新日期: 2026-04-08 | 17 张表全量覆盖，三模块架构（工单/对话/知识库）*
