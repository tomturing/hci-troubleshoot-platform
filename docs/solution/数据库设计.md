...
| **6.2.1** | **2026-04-07** | **Schema 漂移修复**：dev 环境发现 `schema_migrations` 记录与实际 DDL 不一致，创建幂等修复迁移 `20260407001_schema_repair.sql` 补齐 10 张缺失表 + 15 个缺失列。详见 [事件文档](events/2026-04-07-schema-漂移修复方案.md) |
