...
- **创建日期**: 2026-03-11
- **状态**: 开发中
- **关联文档**: [../agent/agent设计.md](../agent/agent设计.md)、[../接口设计.md](../接口设计.md)、[events/2026-04-23-SSH-UX全场景重构方案.md](events/2026-04-23-SSH-UX全场景重构方案.md)
...
| 2026-04-17 | v0.3 | AI 助手选择器智能显示：删除前端环境变量硬开关，改为后端 API 响应驱动（`show_selector` 字段）；新增 `capabilities` 能力标签显示；关联配置详见 [agent设计.md](../agent/agent设计.md) | PR #171 |
...
> 详细配置说明见 [agent设计.md](../agent/agent设计.md)。
