...
关联[需求](../../requirement/hci-sim/events/hci-sim阶段D-Scenario调度与通用KBD测试需求.md)、[方案](../../solution/hci-sim/events/hci-sim阶段D-Scenario调度与通用KBD测试方案.md)和[任务](../../task/hci-sim/events/hci-sim阶段D-Scenario调度与通用KBD测试任务.md)。
