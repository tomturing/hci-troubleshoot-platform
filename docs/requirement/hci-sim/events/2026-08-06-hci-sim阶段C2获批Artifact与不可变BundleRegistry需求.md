...
- [C1 权威 KBD 解析方案](../../solution/hci-sim/events/hci-sim阶段C1权威KBD解析与全量能力验证方案.md)
- [阶段 C 总体需求](2026-08-05-hci-sim阶段C-Fixture编译与注册控制面需求.md)
- [C2 方案](../../solution/hci-sim/events/hci-sim阶段C2获批Artifact与不可变BundleRegistry方案.md)
- [C2 任务](../../task/hci-sim/events/hci-sim阶段C2获批Artifact与不可变BundleRegistry任务.md)
- [C2 验证](../../verify/hci-sim/events/hci-sim阶段C2获批Artifact与不可变BundleRegistry验证报告.md)
