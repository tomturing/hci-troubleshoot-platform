...
| 日期 | 版本 | 变更内容 | 关联事件文档 |
|---|---|---|---|
| 2026-08-20 | v1.1 | 按当前 main 校正 KBD 候选、采集调度和结论门禁；明确真实与仿真使用相同分类完整候选，修正历史 top_k/早停/采集器频次描述 | [仿真诊断等价性与 CDD 全候选修正方案](../../../../solution/agent/events/2026-08-20-仿真诊断等价性与CDD全候选修正方案.md) |
