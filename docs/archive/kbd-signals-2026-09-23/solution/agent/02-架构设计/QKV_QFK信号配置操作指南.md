...
> [KBD 审核发布操作指南](../../../../../solution/agent/KBD审核发布操作指南.md)，字段以 Schema 与
> [关键信号架构设计](../../../../../solution/knowledge-base/关键信号架构设计.md) 为准。

> 版本：v2.1
> 日期：2026-07-27
> 适用对象：运营人员、SRE 工程师
> 信号模型：v2 嵌套文档（`schema_version: 2`，契约见 `backend/shared/schemas/signals/signal.v2.schema.json`）
> 关联文档：[QKV_QFK信号模型v2参考.md](../../../../../solution/agent/02-架构设计/QKV_QFK信号模型v2参考.md)（逐字段对齐的权威参考）、[QKV_QFK扩展性与配置易用性评估.md](../../../../../solution/agent/02-架构设计/QKV_QFK扩展性与配置易用性评估.md)
...
> 关联设计：[2026-07-23-QKV关键信号关键字分类基线校验设计.md](../../../../../solution/events/2026-07-23-QKV关键信号关键字分类基线校验设计.md)
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v2.1 | 2026-07-27 | 增加 QFK match/produces 二选一、host/timeout 真实语义、非 JSON 行列提取填写示例、安全管道转换和 requires 自动推导；关联 [QFK非JSON结果行列提取方案](../../../../../solution/events/2026-07-27-QFK非JSON结果行列提取方案.md) |
