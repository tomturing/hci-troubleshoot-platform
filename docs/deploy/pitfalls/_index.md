...
| K8s/K3s 镜像/Helm/网络/HostPath/DB 迁移/ArgoCD | [k8s.md](k8s.md) | PIT-014~019, PIT-021, PIT-022, PIT-024, PIT-034, PIT-037, PIT-038, PIT-043, PIT-044, PIT-045, D-001, D-002, D-003, D-004, D-009 |
| ArgoCD 升级/多集群/PreSync SA/Redis EOF/PreSync Hook 镜像 | [k8s.md](k8s.md) | D-001, D-002, D-003, D-004, D-005, D-009 |
...
| **D-009** | k8s.md | Helm chart 用 emptyDir 覆盖 `/etc/nginx/conf.d` 导致 nginx 启动无 server block（admin-ui / customer-ui CrashLoopBackOff） |
