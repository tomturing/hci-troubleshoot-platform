...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| **1.18** | **2026-05-07** | **ops-agent 跨仓库自动联动部署方案（待实现）**：设计 ops-agent 仓库发布时自动触发 hci-platform-env 更新 opsAgent.image.tag 的联动机制。当前手动更新方案已实现 `/ops-agent-update` skill。详见 [事件文档](events/2026-05-07-ops-agent跨仓库自动联动部署方案.md) |
...
*文档版本: 1.20 | 更新日期: 2026-04-28 | §12.5: conversation-service Helm 新增 OPS_AGENT env vars，nil 安全取值方式*
