...
| T-KB-PROMPT-DB-01 | seed 升至 v2.1，data migration 021 前向修复已部署 v1.9 | ✅ 代码完成 | 迁移幂等且断言不残留模型侧过滤规则 |
...
| T-KB-BATCH-00 | KBD30880 连续重抽 5 次回归 | ⬜ 待 dev 部署 | 5/5 qkv_task，专家未改时修改数为 0 |
| T-KB-BATCH-01 | 重跑 KBD27079/27173/27222/27653/27736 | ⬜ 待 dev 部署 | 同批发现问题全部闭环 |
