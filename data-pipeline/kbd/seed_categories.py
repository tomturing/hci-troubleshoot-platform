"""
data-pipeline/kbd/seed_categories.py — 从 YAML 导入分类数据到 kb_category 表
...
使用方式：
  uv run python data-pipeline/kbd/seed_categories.py --dry-run
  uv run python data-pipeline/kbd/seed_categories.py
  uv run python data-pipeline/kbd/seed_categories.py --force
