...
- #acli system mv /sf/cfg/gpu_info.ini /sf/data/local#acli hardware gpu ini_host_gpuacli hardware gpu config reset --file xxacli hardware gpu ini_host_gpu
```bash
#
...
- acli system lspci  -nnk -d 10de: |grep 'Kernel driver in use: nvidia'
```bash
