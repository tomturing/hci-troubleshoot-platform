...
class TestAgentRouterRouting:
    ...
    @pytest.mark.asyncio
    async def test_route_s0_to_triage_agent(self, triage_agent, investigation_agent, ai_registry):
        ...
        events = [
            event
            async for event in router.process(
    ...
    @pytest.mark.asyncio
    async def test_route_s1_to_investigation_agent(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_route_all_diagnostic_stages(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_s5_missing_remediation_agent_returns_notice(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_s1_missing_category_id_returns_error(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_route_to_ops_agent_when_enabled(self, triage_agent, investigation_agent, ops_adapter, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_route_to_pai_when_enabled(self, triage_agent, investigation_agent, pai_adapter, ai_registry):
...
class TestAgentRouterFallback:
    ...
    @pytest.mark.asyncio
    async def test_ops_agent_disabled_fallback_to_investigation(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_ops_agent_failure_fallback_to_investigation(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_pai_disabled_fallback_to_investigation(self, triage_agent, investigation_agent, ai_registry):
    ...
    @pytest.mark.asyncio
    async def test_pai_failure_fallback_to_investigation(self, triage_agent, investigation_agent, ai_registry):
...
class TestAgentRouterGetOpsAdapter:
    ...
    def test_get_ops_adapter_when_present(self, triage_agent, investigation_agent, ops_adapter, ai_registry):
        """OpsAdapter 注入时应正确返回"""
        router = AgentRouter(
            triage_agent=triage_agent,
            investigation_agent=investigation_agent,
    ...
    def test_get_ops_adapter_when_not_present(self, triage_agent, investigation_agent, ai_registry):
