...
QFK_VAR_EXECUTIONS_TOTAL = Counter(
    "hci_qfk_var_executions_total",
    "qfk_var 四层变量处理结果计数",
    labelnames=["operation", "mode", "status", "error_code"],
)

QFK_VAR_EXECUTION_DURATION_SECONDS = Histogram(
    "hci_qfk_var_execution_duration_seconds",
    "qfk_var 变量处理端到端耗时（秒）",
