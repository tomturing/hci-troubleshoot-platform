...
import httpx
from typing import AsyncGenerator, Dict, Any, List, Optional, Protocol, runtime_checkable
import json
...
class AIAssistantRegistry:
    ...
    def get_client(self, assistant_type: Optional[str] = None) -> Optional[AIAssistantClient]:
        """获取指定类型的AI助手客户端"""
