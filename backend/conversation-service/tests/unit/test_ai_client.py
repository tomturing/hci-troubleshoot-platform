...
class TestOpenClawAssistantAuth:
    ...
    def test_internal_gateway_prefers_gateway_token(self, monkeypatch):
        monkeypatch.setenv("OPENCLAW_API_KEY", "provider-key")
        ...
        assert client._resolve_auth_token("http://10.42.0.123:18789") == "gateway-token"
    ...
    def test_external_provider_prefers_provider_api_key(self, monkeypatch):
        ...
        assert client._resolve_auth_token("https://open.bigmodel.cn/api/paas/v4") == "provider-key"
    ...
    def test_cluster_service_dns_is_treated_as_internal_gateway(self, monkeypatch):
        ...
        assert client._resolve_auth_token("http://openclaw.hci-staging.svc.cluster.local:18789") == "gateway-token"
